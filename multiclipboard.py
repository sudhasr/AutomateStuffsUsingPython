...
We are using shelve module which saves variables in 
python program to binary shelf files"""

import pyperclip
import sys
import shelve

#Save and load the text in the shelve file
a = shelve.open('mcb')

#Store clipboard content to the keyword
